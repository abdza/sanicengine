    ...
    for ctracker in trackersarray:
        ...
        for ctransition in ctracker['transitions']:
            ...
            if transition:
                ...
                transition = TrackerTransition(tracker=tracker,name=ctransition['name'],display_fields=ctransition['display_fields'],edit_fields=ctransition['edit_fields'])
